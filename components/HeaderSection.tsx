      ...
      <div className="container relative z-10 mx-auto px-0 pt-20 md:px-5 lg:px-1 lg:py-5">
        <div className="flex min-h-[400px] flex-col items-center justify-between gap-[30px] md:flex-row">
          <div className="mb-2 w-full text-left md:max-w-[1000px]">
            <h1
              className="mb-2 font-akira font-bold tracking-tighter"
            ...
            <h1
              className="mb-2 font-malinton text-2xl font-normal tracking-tighter text-gray-300 md:text-2xl lg:text-2xl"
              style={{ fontSize: '2rem' }}
            >
            ...
            <div className="flex items-center justify-center gap-2">
              ...
              <p className="text-md font-malinton font-normal leading-relaxed text-gray-600 text-white dark:text-gray-300">
                We help{' '}
            ...
            <div className="mt-10">
              ...
              <div className="text-md mt-10 font-malinton text-gray-300">
