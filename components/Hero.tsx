        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            >
              <Link
                href="/#contact"
                className="group px-8 py-4 bg-primary text-white rounded-full font-semibold text-lg hover:bg-primary/90 transition-all flex items-center gap-2 shadow-lg hover:shadow-xl"
              >
                Get Our Services
